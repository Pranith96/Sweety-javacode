...
public class MainMethod {
	...
	public static void main(String[] args) {
		MethodOverridenClassExample methodOverridenClassExample = new MethodOverridenClassExample(); // compile time
		...
		MethodOverridenClassExample.message(); // static method should be called directly by class name, no need to
												// create object
